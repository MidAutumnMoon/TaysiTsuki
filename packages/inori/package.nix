...
tsuki.rust.buildRustPackage {
    ...
    src = fetchFromGitHub {
        owner = "MidAutumnMoon";
        repo = "InOri";
        rev = "7f03198e64c3d2696311a17cd3fc6fca49329874";
        hash = "sha256-l1s3opXJNuW/wPjywfVJP5G+XKpsOemhPJB1YAMCuy0=";
    };

    cargoHash = "sha256-as0XbckwtoYYhpP5592QnExmwRszmkvmt/rmCEstIGI=";
