...
tsuki.rust.buildRustPackage {
    ...
    src = fetchFromGitHub {
        owner = "MidAutumnMoon";
        repo = "InOri";
        rev = "2eb40be99210f6e17e5f17f51a671b0abbd653a8";
        hash = "sha256-Da+24Bzx7SQHlo8Jtv8bXksW+OKMv6UwFQrQqXpbYXc=";
    };

    cargoHash = "sha256-DvrdfeWTdi91acXlYLNKjfBklaIk8O8/LaQUqBTBlfk=";
