...
tsuki.rust.buildRustPackage {
    ...
    src = fetchFromGitHub {
        owner = "MidAutumnMoon";
        repo = "InOri";
        rev = "9c607541abe504aedc5ea76c4e365646682c995c";
        hash = "sha256-hDSskDQTbl9EyAT3Xb+x3tZI678RYmZJ+Dr7NQU/Zoo=";
    };

    cargoHash = "sha256-lfKFlQSzUD3S7Z4bd+gbbSMD3vzxTldprvJYBeRBozc=";
