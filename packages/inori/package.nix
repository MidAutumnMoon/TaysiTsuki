...
tsuki.rust.buildRustPackage {
    ...
    src = fetchFromGitHub {
        owner = "MidAutumnMoon";
        repo = "InOri";
        rev = "c74d543bdf5525963ece1770610aa51fe037fca4";
        hash = "sha256-LPiphd3hoivMavCv1bl4mPwieGNjzAD8AX3VZNdLXFA=";
    };

    cargoHash = "sha256-1ZZXh1s7NiWPD8qgH4KlZfvy3uSjy9RDUv4L1NhXDmE=";
