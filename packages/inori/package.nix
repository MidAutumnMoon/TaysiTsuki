...
tsuki.rust.buildRustPackage rec {
    ...
    src = fetchFromGitHub {
        owner = "MidAutumnMoon";
        repo = "InOri";
        rev = "ff8ea603e961ad6fccb517b2d79ff15f6d164e5d";
        hash = "sha256-y+WYPS5P60whMeCSMIn+S7DJcUuf0kT2dLSBuPzSKJU=";
    };

    cargoHash = "sha256-QDDGooILTdCI7DIvq9aaQ00NAcPYFfweDLxvrGO2FSM=";
