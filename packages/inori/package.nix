...
tsuki.rust.buildRustPackage rec {
    ...
    src = fetchFromGitHub {
        owner = "MidAutumnMoon";
        repo = "InOri";
        rev = "8cff868e20be088ebbf8ff8fd8393a9ca6915725";
        hash = "sha256-m2iY8o51P2vRSb/MUSIuEVlt0TVZZ8vm/RUneghOjJU=";
    };

    cargoHash = "sha256-wgSu3z07zbJnIe6tdrfVo+jSfuFCC8FGzIg5VnFzJSU=";
