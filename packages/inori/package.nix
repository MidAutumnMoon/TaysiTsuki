...
tsuki.rust.buildRustPackage {
    ...
    src = fetchFromGitHub {
        owner = "MidAutumnMoon";
        repo = "InOri";
        rev = "64bc31eb1f39a246312e8ce0e2fc1c1cab13a6cb";
        hash = "sha256-zSuQFL7BMHRDdRVCAC3IrNBJe4lL/ZkARTq6nndzq3Y=";
    };

    cargoHash = "sha256-/s+jTBSyNffzKKJLqd/yDs5sgC/zFWtrW5U/avfl86M=";
