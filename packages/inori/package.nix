...
tsuki.rust.buildRustPackage {
    ...
    src = fetchFromGitHub {
        owner = "MidAutumnMoon";
        repo = "InOri";
        rev = "691a50a1b5d432d6d0ea6f8f1a28f16f9111ddd3";
        hash = "sha256-xy0bN6NEzmQk48RDidwX9d9AfsQRSIZcThZBthFrz3Y=";
    };

    cargoHash = "sha256-gWCLZZ3aMiiANPZMQzlX80kp7ypNSajOvscAbDsdLf0=";
