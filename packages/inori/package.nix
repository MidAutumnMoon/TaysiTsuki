...
tsuki.rust.buildRustPackage {
    ...
    src = fetchFromGitHub {
        owner = "MidAutumnMoon";
        repo = "InOri";
        rev = "4ef477a1f3e94d6f95e85eda5439db5e9dab6737";
        hash = "sha256-oSzSrxa3HBz8eirF+YO6HBvLDXNMmPFrbDB+XzvKzbM=";
    };

    cargoHash = "sha256-2qowosHJrJ7ZndLUdyAPD6yZjjLZlSpmqWmAJrTv2EY=";
