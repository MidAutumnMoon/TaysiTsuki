...
tsuki.rust.buildRustPackage rec {
    ...
    src = fetchFromGitHub {
        owner = "MidAutumnMoon";
        repo = "InOri";
        rev = "b304b70e9194bd58733dab3644bdc4a0a775b8ae";
        hash = "sha256-DRzf95vFWqymCy/BjG4HgToygshZpueOqTWGlHXAmP4=";
    };

    cargoHash = "sha256-rkUyD8F85iU239i+h58ExdX2JAQqg2MuSLM+fHimobw=";
