...
tsuki.rust.buildRustPackage {
    ...
    src = fetchFromGitHub {
        owner = "MidAutumnMoon";
        repo = "InOri";
        rev = "be402d26356d606a1fffe3312899a7abc04f5887";
        hash = "sha256-TpI91C+t4TYlATIdePPabb0eKXBiKHZJwMTRjI/tC20=";
    };

    cargoHash = "sha256-jOJLwLsf8kyQav/23Sk56PXlZjkGPcddxOuVzrlFZFw=";
