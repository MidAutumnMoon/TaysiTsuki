...
tsuki.rust.buildRustPackage {
    ...
    src = fetchFromGitHub {
        owner = "MidAutumnMoon";
        repo = "InOri";
        rev = "a1667afe7c4817494c572084f17f2175667a3e65";
        hash = "sha256-oPYPaeSHFA5neXAoDnLanJJXWhGE1CGBtDQt/sAs9ig=";
    };

    cargoHash = "sha256-bRMELQPVUT6aixAuSLWOAlS3HYfQLEP6Rq2wjJyAqio=";
