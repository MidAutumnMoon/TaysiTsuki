...
tsuki.rust.buildRustPackage rec {
    ...
    src = fetchFromGitHub {
        owner = "MidAutumnMoon";
        repo = "InOri";
        rev = "8dcd90b25c7d57b2d50f4a1409520339c8996c66";
        hash = "sha256-4eNWuUwu7rbUya5JrQLD1vDBrYOLy7OE51PYWzpI+CQ=";
    };

    cargoHash = "sha256-6+OyqcpSSY3IjPHnZP6dBBxGyUUuHau5G6ieEqBL2+w=";
