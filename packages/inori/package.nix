...
tsuki.rust.buildRustPackage {
    ...
    src = fetchFromGitHub {
        owner = "MidAutumnMoon";
        repo = "InOri";
        rev = "8c452e3b304a9547ae4e11d645aac6165cd8a8a1";
        hash = "sha256-phBZPtGdlFIBd7ONLEdYxjFDbKuUfUK914wBqhwPxcM=";
    };

    cargoHash = "sha256-3HjfDn4r/xe7oJU9ZqZXsjLxnfxQBPO4hxfrCyjNu3o=";
