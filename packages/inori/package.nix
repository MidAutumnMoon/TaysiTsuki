...
tsuki.rust.buildRustPackage rec {
    ...
    src = fetchFromGitHub {
        owner = "MidAutumnMoon";
        repo = "InOri";
        rev = "bc9d921a345f0d95ff19e6bf4031627f48048b20";
        hash = "sha256-WMsAiUWgHRnatyqTMHRV9RZeFnZdZLQR6onuynsGUD8=";
    };

    cargoHash = "sha256-U0y3d1D0jQ9NklwiHzWCqg1XL1I55Xhd05iHRqu8FzU=";
