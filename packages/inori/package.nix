...
tsuki.rust.buildRustPackage {
    ...
    src = fetchFromGitHub {
        owner = "MidAutumnMoon";
        repo = "InOri";
        rev = "3cb371f2771ec0dbce24bd10665a0050901f91a4";
        hash = "sha256-Wys2LZD59Q/T3QJQALGsGlQcvygWGMMq+kluv2XAFDM=";
    };

    cargoHash = "sha256-ZP1ZyvFRzuI48FdoifHOLTcQE4GkQQhw/0XAGKYVMCU=";
